...
class Music(models.Model):
    ...
    music_type = models.CharField(max_length=20, choices=MUSIC_TYPE_CHOICES)
    ...
    class Meta:
        ...
        permissions = [
            ("upload_music", "Can upload music"),
            ("edit_own_music", "Can edit own music"),
            ("delete_own_music", "Can delete own music"),
            ("manage_beats", "Can manage beats"),
        ]
